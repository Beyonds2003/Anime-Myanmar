...
function SignUp({
  ...
  const [lockErrorMsg, setLockErrorMsg] = React.useState(
      ...
      <div className="signForm">
        {login && loginError && (
          <div className="errorLogin">
            ...
            <Typography style={{ fontSize: "13px", marginLeft: "7px" }}>
              {lockErrorMsg}
            </Typography>
          </div>
        )}
        {!login && (
          <div style={{ marginTop: "20px" }}>
            <TextField
              ...
              helperText={checkError.name && "Enter Name"}
              id="outlined-textarea"
              name="name"
              value={signValue.name}
        ...
        <div style={{ marginTop: "20px" }}>
          <TextField
            ...
            helperText={checkError.email && emailError}
            InputProps={{
              endAdornment: (
                <InputAdornment position="end">
                  <MailIcon />
              ...
              <Box style={{ width: "100px" }}>
                <FormControl fullWidth size="small">
                  ...
                  >
                    ...
                    <MenuItem value={"No wish to answer"}>
                      No wish to answer
                    </MenuItem>
                  </Select>
                </FormControl>
        ...
        {!login && (
          <div className="privacyA">
            <Typography>
              I agree with <span className="blueS">Terms</span> and{" "}
              <span className="blueS">Privacy</span>
            </Typography>
          </div>
        )}
        {login && (
          <div className="privacyB">
            <FormGroup>
              <FormControlLabel
                control={
                  <Checkbox style={{ color: "#009eff" }} defaultChecked />
                }
                label="Remember me"
              />
            </FormGroup>
        ...
        <div className="signManual">
          {login ? (
            <Button id="signManual" fullWidth onClick={handleLogin}>
              Log in
            </Button>
          ) : (
            <Button id="signManual" fullWidth onClick={handleSignUp}>
              Sign up
            </Button>
          )}
          {login && (
            <div className="privacyA">
              <Typography onClick={() => setForgotPassword(true)}>
                <span className="blueS">Forgot Password?</span>
              </Typography>
            </div>
          )}
        </div>
        <div style={{ textAlign: "center", marginTop: "20px" }}>
          ...
          {login ? (
            ...
            >
              <span className="blueS">Sign up</span>
            </Typography>
          ) : (
            <Typography
              onClick={() => (
            ...
            >
              <span className="blueS">Log in</span>
            </Typography>
          )}
        </div>
      </div>
