...
function DetailPage() {
  ...
  let firstEpNum = 0;
  let animecount = check1 && data?.epcount[0];
            ...
            <div className="info info2">
              <div className="info-child info-child2">
                <div className="child">
                  ...
                  <Typography className="notranslate" id="tit" gutterBottom>
                    {data.title}
                  </Typography>
                  <div className="flex">
                    <div className="flex marginT">
                      <StarIcon id="star2" />
                      <Typography id="fontForD" style={{ color: "gold" }}>
                        {data.rating}
                      </Typography>
                    </div>
                    ...
                    <div className="flex marginT margin1">
                      <Typography id="fontForD">
                        {data?.epcount[0]} Episodes
                      </Typography>
                    </div>
                  </div>
                  ...
                  <div className="flex marginT">
                    <div className="flex  ">
                      <Typography id="fontForD" style={{ color: "#82859c" }}>
                        Region: &nbsp;
                      </Typography>
                  ...
                  <div className="marginT">
                    ...
                    <div className="allButs">
                      <Button id="play-but">
                        ...
                        />{" "}
                        <span style={{ marginRight: "10px" }}>Play</span>
                      </Button>
                      {userInfo ? (
                        <>
                          {userInfo.watchLater.includes(data.title) ? (
                            ...
                            >
                              <BookmarkAddIcon style={{ marginRight: "5px" }} />{" "}
                              <span
                                className="rmForM"
                                style={{
                                  marginRight: "10px",
                      ...
                      <Button
                        onClick={() => (
                          setUrl2Name(`${url2}/v1/album/${data._id}`),
                          setShareBox(true)
                        )}
                        id="play-but2"
