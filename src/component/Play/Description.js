...
function Description({ ep, epCount, load, dada }) {
  ...
  const getEpString = ep.epname.split(" ").at(-1);
        ...
        <div className="desCon">
          <div className="flex">
            <Typography
              variant="h5"
              id="desTit"
              style={{ fontWeight: "bold", margin: "20px 0px 0px 5px" }}
            >
              {ep.Mtitle}
            </Typography>
            {epCount > 1 && (
              <div className="flex" style={{ minWidth: "160px" }}>
                ...
                <Typography id="tellEp">Episode {getEpString}</Typography>
              </div>
            )}
          </div>
          <div>
            <div className="child">
              <Typography id="tit" gutterBottom>
                {ep.title}
              </Typography>
              <div className="flex">
              ...
              <div className="marginT marginL">
                <Typography id="fontForD" style={{ textAlign: "start" }}>
                  {dada.type}
                </Typography>
              </div>
              <div className="flex marginT marginL">
              ...
              <div className="marginT borT marginL">
                <div className="flex">
                  {!more ? (
                    <Typography id="fontForD" style={{ textAlign: "start" }}>
                      <span style={{ color: "#82859c" }}>Description: </span>
                      &nbsp;{" "}
                      {dada?.description?.split(" ").slice(0, 40).join(" ")}...
                    </Typography>
                  ) : (
                    <Typography id="fontForD" style={{ textAlign: "start" }}>
                      <span style={{ color: "#82859c" }}>Description: </span>
