...
function Home() {
  const { anime, shareBox, setShareBox, setUrl2Name, url2 } =
  ...
  return (
    <div className="containForSwiper">
      ...
      >
        {anime &&
          anime.slice(anime.length - 6).map((data) => (
            <SwiperSlide key={data._id}>
              <div
                className="imgCon"
                onClick={() => {
                  if (window.innerWidth < 764) {
                    navigate(`/v1/album/${data._id}`);
                  }
                }}
              >
                <img
                ...
                <div className="info">
                  <div className="info-child">
                    <div className="child">
                      ...
                      <motion.div
                        className="marginT mobile_remove"
                        initial={{ opacity: 0, y: 30 }}
                        whileInView={{
                          opacity: 1,
                          y: 0,
