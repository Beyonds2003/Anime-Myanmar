...
function DeletePage() {
  const { setDeleteAcc, userInfo, url, setUserInfo } =
  ...
  const handleDelete = async () => {
    try {
      ...
      const { data } = await axios.post(`${url}v1/myAccount/delete`, {
        deleteAcc: userInfo.id,
        password: pass,
      });
      ...
      <div className="signConc">
        <Paper elevation={3} id="sharePaper">
          ...
          <div className="deleteText">
            <Typography id="askQforDelete">
              Are you sure you want to delete this account?
            </Typography>
            <Typography id="warningForDelete">
              This action can't be undone. When you delete all your data, it
              will be erased from our system. Type your account password to
              perform this action.
            </Typography>
            <TextField
            ...
            <div style={{ marginTop: "40px" }}>
              <Button id="deleteAccBut" onClick={handleDelete}>
                Delete
              </Button>
              <Button id="deleteCancel" onClick={() => setDeleteAcc(false)}>
                Cancel
              </Button>
            </div>
          </div>
