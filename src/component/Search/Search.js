      ...
      {load ? (
        <>
          <div className="searchCon">
            ...
            {foundAm.length === 0 && (
              <Typography>{`No "${queryData}" Found.`}</Typography>
            )}
              ...
              {foundAm.map((dada) => (
                ...
                >
                  <Paper
                    elevation={6}
                    id="paperC"
                    onClick={() => navigate(`/v1/album/${dada._id}`)}
                  >
                    <div className="imgCoc4">
                      <img
                        src={dada.frontPicture}
                    ...
                    <div className="abso_child2">
                      ...
                      <div className="flex">
                        <Typography
                          gutterBottom
                          style={{ fontSize: "14px" }}
                        >{`Year: ${dada.date}`}</Typography>
                        <div className=" margin1">
                          <Typography
                            gutterBottom
                            style={{ fontSize: "14px" }}
                          >{` ${dada.epcount[0]} Episodes`}</Typography>
                        </div>
                      </div>
