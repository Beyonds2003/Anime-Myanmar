                ...
                <div className="textMain">
                  ...
                  <div className="flex" style={{ marginBottom: "7px" }}>
                    <div className="flex">
                      ...
                      <Typography style={{ fontSize: "12px", color: "gold" }}>
                        {data.rating}
                      </Typography>
                    </div>
                  ...
                  <Typography
                    ...
                    gutterBottom
                  >
                    {data.description.split(" ").slice(0, 23).join(" ")} ...
                  </Typography>
                  <div className="moreInfoL">
                    <Typography
                      style={{ color: "#0486D2" }}
                      variant="body2"
                      gutterBottom
