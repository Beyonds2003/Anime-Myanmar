  ...
  return (
    <div className="listCon">
      <div className="listMain">
        <div>
          <div>
            <Typography variant="h6" gutterBottom id="popular">
              All Animes
            </Typography>
            <div style={{ width: "100vw", position: "relative" }}>
              <div className="container1">
                ...
                >
                  {Mload &&
                    allAnimes.map((data, index) => {
                      return (
                        <SwiperSlide
                          key={index}
                          className="swiper_first"
                          width={"270px"}
                          onMouseEnter={() =>
                            (document.getElementsByClassName("swiper_first")[
                              index
                            ].style.zIndex = "100")
                          }
                          onMouseLeave={() =>
          ...
          {spS && (
            <div
              className="distinctContinue"
              style={{ background: "rgb(16, 18, 20)" }}
            >
              <Typography variant="h6" gutterBottom id="continue_w">
                Continue Watching
              </Typography>
              <div
                style={{
                  ...
                  {Mload &&
                    trending.map((data, index) => {
                      return (
                        <SwiperSlide
                          key={index}
                          className="swiper_first4"
                          width={"270px"}
                          onMouseEnter={() =>
                            (document.getElementsByClassName("swiper_first4")[
                              index
                            ].style.zIndex = "100")
                          }
                          onMouseLeave={() =>
          ...
          <div className="distinct" style={{ background: "rgb(16, 18, 20)" }}>
            ...
            <Paper elevation={3} id="quotesCard">
              ...
              <div className="quotes">
                <div>
                  <Typography id="quotesText">
                    Those who <span className="quoteColor">regretted</span>{" "}
                    their own action. I would never{" "}
                    <span className="quoteColor">trample</span> over them.
                    Because{" "}
                    <span className="quoteColor"> demons were once human</span>,
                    too. Just like me, they were{" "}
                    <span className="quoteColor">human</span>, too.
                  </Typography>
                  <Typography id="quotesAutor">"Tanjiro Kamado"</Typography>
                  <Typography id="quotesAutor" style={{ margin: "0px" }}>
                    From Demon Slayer
                  </Typography>
                </div>
              </div>
          ...
          <div className="distinct" style={{ background: "rgb(16, 18, 20)" }}>
            ...
            <div style={{ width: "100vw", position: "relative" }}>
              <div className="container1">
                ...
                >
                  {Mload &&
                    popularOnAnimeMyanmar.map((data, index) => {
                      return (
                        <SwiperSlide
                          key={index}
                          className="swiper_first2"
                          width={"270px"}
                          onMouseEnter={() =>
                            (document.getElementsByClassName("swiper_first2")[
                              index
                            ].style.zIndex = "100")
                          }
                          onMouseLeave={() =>
                  ...
                  {Mload &&
                    drama.map((data, index) => {
                      return (
                        <SwiperSlide
                          key={index}
                          className="swiper_first3"
                          width={"270px"}
                          onMouseEnter={() =>
                            (document.getElementsByClassName("swiper_first3")[
                              index
                            ].style.zIndex = "100")
                          }
                          onMouseLeave={() =>
              ...
              <div className="quotes">
                <div>
                  <Typography id="quotesText">
                    ...
                    <span className="quoteColor">lives</span> I can value.
                    And... I decided who those people were six years ago. So you
                    shouldn't try to ask for my{" "}
                    <span className="quoteColor">pity</span>. Because right now,
                    I don't have{" "}
                    <span className="quoteColor">
                      time to spare or room in my heart.
                    </span>
                  </Typography>
                  ...
                  {Mload &&
                    action.map((data, index) => {
                      return (
                        <SwiperSlide
                          key={index}
                          className="swiper_first5"
                          width={"270px"}
                          onMouseEnter={() =>
                            (document.getElementsByClassName("swiper_first5")[
                              index
                            ].style.zIndex = "100")
                          }
                          onMouseLeave={() =>
